...
export class StockTrackerService {
  ...
  // manage a list of stock items that correspond to localStorage items.
 ...
 */
   ...
   */
  private getStockQuoteData(symbol: string): Observable<StockQuoteData> {
   ...
   */
  private getStockSymbolLookup(symbol: string): Observable<StockSymbolLookup> {
   ...
   */
  private getStockSentiment(symbol: string): Observable<StockSentiment> {
   ...
   * @param symbol researched symbol.
   */
  private createStock(symbol: string): void {
